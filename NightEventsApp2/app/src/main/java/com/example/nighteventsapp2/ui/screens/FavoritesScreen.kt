...
import com.example.nighteventsapp2.ui.theme.eventList


@Composable
fun FavoritesScreen(navController: NavHostController){
    val favariteEvents = eventList.filter { it.isFavorite.value }

    LazyColumn (
        modifier = Modifier.padding(16.dp)
    ) {
        if (favariteEvents.isEmpty()) {
            item {
                Text(
