package com.example.tasksmanagerapp.data.source
...
object DataStoreUtils {
    ...
    suspend fun readTasks(context: Context) : Flow<String> = context.dataStore.data.map{
        prefs -> prefs[TASKS_KEY] ?: ""
    }
    ...
    fun readTheme(context: Context) : Flow<Boolean> = context.dataStore.data.map {
        prefs -> prefs[THEME_KEY] ?: false
    }
}